...
// @connect     *
// @run-at      document-end
// @require     https://cdn.jsdelivr.net/npm/artplayer@5.0.9/dist/artplayer.js
// @require     https://cdn.jsdelivr.net/npm/artplayer-plugin-control@2.0.0/dist/artplayer-plugin-control.js
...
(function () {
  ...
  function handleResponse(r) {
    ...
    for (let item of r.list) {
      ...
      let nameEqual = item.vod_name == videoName.replace(" ","")
  ...
  const search = (url) =>
    new Promise((resolve, reject) => {
      GM_xmlhttpRequest({
        method: "GET",
        url: encodeURI(`${url}?ac=detail&wd=${videoName.replace(" ","")}`),
        timeout: 3000,
        responseType: "json",
        onload(r) {
          try {
